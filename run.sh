...
# publishes for public-IP key-auth ssh (4444) + public mosh (60000-61000/udp).
#
...
# ssh on host:4444 → container:22 (key auth); mosh public on UDP 60000-61000.
...
echo "  mosh -p 4444 core@<public-ip>    (or via tailnet)"
