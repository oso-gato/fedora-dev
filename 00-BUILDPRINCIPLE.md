...
- **Deploy-contract (every image ships a single sanctioned `run.sh`)** — a *functional requirement of the artifact* → carried by **R10** (autonomous deploy) + each repo's `CLAUDE.md` Principle 7, not re-created here.
